...
def build_pdf_report(
    ...
    """
    Build a one-page PDF weight & balance report and return it as an in-memory buffer.
    Includes logo, aircraft details, and weighing data.
    """
...
display a 2D diagram, and generate a PDF Weight & Balance report.
"""
)
