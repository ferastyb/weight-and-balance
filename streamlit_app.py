...
def build_pdf_report(
    ...
    c.drawString(margin_x + logo_width + 20, y - 10, "Boeing 7x7 Weight & Balance Report")
    ...
    c.drawString(
        margin_x,
        y,
        "Note: This report is generated by the Feras Aviation B7x7 CG Calculator tool. "
