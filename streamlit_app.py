...
def build_pdf_report(
    ...
    Includes logo, aircraft details, weighing data, and CG diagram.
    """
    ...
    c.drawString(margin_x + logo_width + 20, y - 10, "Boeing 787 Weight & Balance Report")
    ...
    draw_detail("Aircraft Type", aircraft_type or "B787")
    ...
    c.drawString(
        margin_x,
        y,
        "Note: This report is generated by the Feras Aviation B787 CG Calculator tool. "
    ...
    if cg_diagram_png is not None:
        ...
        max_height = height - 120  # leave top/bottom margins
...
display a 2D diagram, and generate a PDF Weight & Balance report (with CG diagram).
"""
)
...
with dcol1:
    ...
    aircraft_type = st.text_input("Aircraft type", value="Boeing 787")
with dcol2:
...
if calculate:
    ...
    st.info("Enter your aircraft details and weighing data, then click **Calculate CG**.")
